...
(defun-builtin-plutus plutus-choose-list (a b c)
  (error "TODO"))

(defun-builtin-plutus plutus-mk-cons (a b)
  (error "TODO"))
...
(defun-builtin-plutus plutus-null-list (a)
  (error "TODO"))

(defun-builtin-plutus plutus-if-then-else ((a plutus-bool) b c)
  (if (from-plutus a) b c))

(defun-builtin-plutus plutus-choose-unit (a b)
  (error "TODO"))

(defun-builtin-plutus plutus-error ()
  (error 'plutus-error-signal))

(defun-builtin-plutus plutus-trace (a b)
  (error "TODO"))

(defun-builtin-plutus plutus-choose-data (a b c d e)
  (error "TODO"))
